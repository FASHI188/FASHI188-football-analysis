...
R=Path(__file__).resolve().parents[2]; BASE='47e0b8f81b1e2fe13b4d3cd28f09ed7f718f6342'; N=25; AFTER=170; B='phase2b-batch10'
...
def main():
 try:
  ...
  for s,h in m['entries']:
   assert plan[s]['disposition']=='ARCHIVE'; a=f'governance/archive/workflows/{B}/'+Path(s).name; assert bs(BASE,s)==h and not ex('HEAD',s) and ex('HEAD',a) and bs('HEAD',a)==h
 ...
 print('PASS phase2b_batch10'); return 0
