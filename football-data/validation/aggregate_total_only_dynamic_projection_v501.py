...
REPORT_DIR = ROOT / "manifests" / "total_only_dynamic_projection_v501"
OUT = ROOT / "manifests" / "total_only_dynamic_projection_v501_status.json"
...
def main() -> int:
    ...
    payload = {
        "schema_version": "V5.0.1-total-only-dynamic-projection-aggregate-r1",
        ...
        "policy": "Total-only dynamic research. Formal V5 probabilities remain unchanged.",
    }
