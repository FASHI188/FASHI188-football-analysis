...
OUT_DIR = ROOT / "manifests" / "ah_constrained_dynamic_blend_v501"
...
def main() -> int:
    ...
    try:
        ...
        code = validation.SOURCE_CODES[competition_id]
        report = validation._domain(competition_id, profile_id, code)
