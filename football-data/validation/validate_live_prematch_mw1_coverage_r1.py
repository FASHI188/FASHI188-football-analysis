...
def main() -> int:
    ...
    for match_id, kickoff, home, sh, away, sa in FIXTURES:
        payload = {
            ...
            "home_team": home,
            "away_team": away,
            "strength_home_team": sh,
            "strength_away_team": sa,
            "kickoff_utc": kickoff,
            "freeze_time_utc": FREEZE,
            "neutral_venue": False,
            "evidence": [],
        }
        try:
            ...
            rows.append({
                ...
                "one_x_two": result["probabilities"]["one_x_two"],
    ...
    report = {
        "schema_version": "live-prematch-runtime-r1-mw1-coverage",
        ...
        "status": "PASS_FULL_COVERAGE" if failed == 0 else "PARTIAL_COVERAGE",
        "rows": rows,
    ...
    # Diagnostic coverage test should produce an artifact even when incomplete.
    return 0
