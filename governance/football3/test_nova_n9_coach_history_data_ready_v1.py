...
class N9CoachTests(unittest.TestCase):
    ...
    def test_bind_uses_names_not_results(self):
        targets=[{'fixture_id':'u1','date':'2022-08-05','league':'EPL','home_name':'Tottenham','away_name':'Southampton'}]
        games=[{'game_id':'9','competition_id':'GB1','season':'2022','date':'2022-08-05','home_club_name':'Tottenham Hotspur','away_club_name':'Southampton FC','home_club_id':'1','away_club_id':'2'}]
        cfg={'minimum_side_similarity':.45,'minimum_pair_similarity':1.15,'minimum_margin':.08}
        b,d=bind_targets(targets,games,{'EPL':'GB1'},cfg); self.assertEqual(len(b),1); self.assertFalse(d)
